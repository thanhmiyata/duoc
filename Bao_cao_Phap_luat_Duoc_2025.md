...
**Lý do chọn đề tài:**  
Năm 2025 đánh dấu bước ngoặt lớn với việc thực thi Luật sửa đổi, bổ sung một số điều của Luật Dược (Luật số 44/2024/QH15) và Nghị định 163/2025/NĐ-CP. Việc nghiên cứu các quy định về Chứng chỉ hành nghề (CCHN) và Giấy chứng nhận đủ điều kiện kinh doanh dược (GCN ĐĐK KDD) trong giai đoạn mới này là vô cùng cấp thiết để các doanh nghiệp và dược sĩ nắm bắt kịp thời các quy định mới nhất, tránh sai sót trong quá trình tuân thủ pháp luật.
...
Căn cứ theo **Văn bản hợp nhất 39/VBHN-VPQH** (Điều 17) và **Nghị định 163/2025/NĐ-CP** (Chương II):
...
- **Giảm thời gian thực hành (Điều 15 Nghị định 163/2025):** Giảm 3/4 thời gian đối với Tiến sĩ/CKII; giảm 1/2 thời gian đối với Thạc sĩ/CKI.

#### 1.2.2. Quy định về Giấy chứng nhận ĐĐK KDD (Cơ sở XNK)
Căn cứ theo **Văn bản hợp nhất 39/VBHN-VPQH** (Điều 33) và **Nghị định 163/2025/NĐ-CP** (Mục 1 Chương III):
...
- **Biện pháp an ninh (Điều 31 Nghị định 163/2025):** Đối với thuốc kiểm soát đặc biệt, phải có kho/khu vực riêng có khóa chắc chắn, hệ thống camera theo dõi và hồ sơ sổ sách theo dõi nghiêm ngặt.
...
```mermaid
graph TD
    A[Bắt đầu] --> B[Chuẩn bị hồ sơ theo Điều 2 Nghị định 163/2025]
    B --> C[Nộp hồ sơ trực tuyến/trực tiếp tại Sở Y tế/Bộ Y tế]
    C --> D{Kiểm tra tính hợp lệ?}
    D -- Không hợp lệ --> E[Thông báo bổ sung trong 7 ngày làm việc - Mẫu 16]
    E --> B
    D -- Hợp lệ --> F[Thẩm định hồ sơ/Tổ chức thi - Điều 5, 6 NĐ 163]
    F --> G[Cấp CCHN Dược - Mẫu 06 hoặc 07]
    G --> H[Công bố thông tin trên Cổng thông tin điện tử trong 03 ngày]
    H --> I[Kết thúc]
```

#### 2.1.2. Mô tả chi tiết từng bước
- **Bước 1: Chuẩn bị hồ sơ (Điều 2 Nghị định 163/2025).** Gồm Đơn (Mẫu 02); Giấy xác nhận thời gian thực hành (Mẫu 03); Giấy khám sức khỏe; Bản sao văn bằng chuyên môn.
- **Bước 2: Nộp hồ sơ (Điều 6 Nghị định 163/2025).** Nộp về Sở Y tế (đối với xét hồ sơ) hoặc Bộ Y tế (đối với thi).
- **Bước 3: Tiếp nhận và xử lý.** Thời hạn cấp là 20 ngày (xét hồ sơ) hoặc 15 ngày (thi - theo Luật). Nghị định 163 quy định chi tiết lịch trình thi và trả kết quả.
...
```mermaid
graph TD
    S1[Chuẩn bị hồ sơ theo Điều 20 Nghị định 163/2025] --> S2[Nộp hồ sơ về Bộ Y tế - Cục Quản lý Dược]
    S2 --> S3{Kiểm tra hồ sơ?}
    S3 -- Cần sửa đổi --> S4[Thông báo yêu cầu sửa đổi trong 07 ngày làm việc]
    S4 --> S1
    S3 -- Hợp lệ --> S5[Tổ chức đánh giá thực tế GSP trong 20 ngày]
    S5 --> S6[Thẩm định thực tế tại cơ sở]
    S6 --> S7{Kết quả đạt?}
    S7 -- Cần khắc phục --> S8[Cơ sở khắc phục và báo cáo trong 06 tháng]
    S8 --> S9[Cục QLD kiểm tra báo cáo khắc phục trong 20 ngày]
    S9 --> S10[Cấp GCN - Mẫu 13]
    S7 -- Đạt --> S10
    S10 --> S11[Công bố thông tin trong 03 ngày làm việc]
    S11 --> S12[Kết thúc]
```
...
- **Bước 2: Nộp hồ sơ (Điều 21 Nghị định 163/2025).** Cơ sở XNK nộp hồ sơ về Bộ Y tế.
...
Báo cáo đã cập nhật chi tiết các quy định từ **Văn bản hợp nhất 39/VBHN-VPQH** và **Nghị định 163/2025/NĐ-CP**. Các thay đổi chủ yếu tập trung vào việc chuẩn hóa hồ sơ (sử dụng các Mẫu biểu mới từ Phụ lục I Nghị định 163), siết chặt các biện pháp an ninh đối với thuốc kiểm soát đặc biệt và tối ưu hóa thời gian thực hành chuyên môn cho người có trình độ cao.
...
5. **Cổng Thông tin điện tử Cục Quản lý Dược - Bộ Y tế:** https://dav.gov.vn
6. **Cổng Dịch vụ công Quốc gia:** https://dichvucong.gov.vn
